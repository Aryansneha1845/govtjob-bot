...
URLS = [
    "https://www.indgovtjobs.in/search/label/Bank+Jobs",
    "https://www.indgovtjobs.in/search/label/IBPS",
]

KEYWORDS = [
    "ibps", "sbi", "bank", "rbi", "nabard", "recruitment",
    "vacancy", "notification", "clerk", "po", "officer", "assistant"
]
...
def _parse_text(text: str, base_url: str) -> list:
    ...
    for line in text.split("\n"):
        ...
        job_id = "bank_" + hashlib.md5(title.encode()).hexdigest()[:12]
        jobs.append({
            "id": job_id,
            "title": title,
