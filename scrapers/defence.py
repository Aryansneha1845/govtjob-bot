...
URLS = [
    "https://www.indgovtjobs.in/search/label/Defence+Jobs",
    "https://www.indgovtjobs.in/search/label/Army",
]

KEYWORDS = [
    "army", "navy", "airforce", "defence", "military", "nda",
    "recruitment", "vacancy", "notification", "soldier", "officer",
    "agniveer", "territorial", "coast guard", "crpf", "bsf"
]
...
def _parse_text(text: str, base_url: str) -> list:
    ...
    for line in text.split("\n"):
        ...
        job_id = "def_" + hashlib.md5(title.encode()).hexdigest()[:12]
        jobs.append({
            "id": job_id,
            "title": title,
