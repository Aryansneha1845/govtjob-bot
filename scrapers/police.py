...
URLS = [
    "https://www.indgovtjobs.in/search/label/Police+Jobs",
    "https://www.indgovtjobs.in/search/label/SSB",
]

KEYWORDS = [
    "police", "ssb", "cisf", "bsf", "crpf", "itbp", "constable",
    "sub inspector", "si", "recruitment", "vacancy", "notification",
    "inspector", "head constable", "cop"
]
...
def _parse_text(text: str, base_url: str) -> list:
    ...
    for line in text.split("\n"):
        ...
        job_id = "pol_" + hashlib.md5(title.encode()).hexdigest()[:12]
        jobs.append({
            "id": job_id,
            "title": title,
